...
router.post("/create-checkout-session", requireAuth, async (req, res) => {
  ...
  const successUrl = env.STRIPE_SUCCESS_URL ?? "http://localhost:5173/subscription-success?session_id={CHECKOUT_SESSION_ID}";
  const cancelUrl = env.STRIPE_CANCEL_URL ?? "http://localhost:5173/subscribe";
